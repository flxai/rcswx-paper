...
def evaluate_test_protein(model, dataloader, config):
...
if __name__ == "__main__":
    path = "/localdisk/home/lericsso/code/einspace/data/psicov"
    cfg = dict(
    ...
    trainset, valset, testset, test_my_list, test_length_dict = build_nasbench360_psicov_dataset(cfg, 4)
